...
slug: "2026/03/30/ictsc2025final/5023"
draft: false
renderer: "md"
sticky: false
---
...
15チーム中9チーム満点で、（おそらく初見/ほとんど触ったことないであろう）プロトコルをその場で解決したのでしょうか。拍手👏

……と言っても、この問題の本筋は IRC はあまり関係ないというオチでした。
見掛け倒しな問題になってしまってすみません。

解法についてですが、どのチームも作問者が想定していた解答ではありませんでした。
7000番ポートを開いたり（本当は7000は plain text な link で使うべき）、swarm 内で link 張ったり（独立したホスト同士を繋げてほしかった）、設定の生成スクリプトを直に変更したりなど……。
...
この問題のタイトルも、登場人物も、そのゲーム関連が由来である。
