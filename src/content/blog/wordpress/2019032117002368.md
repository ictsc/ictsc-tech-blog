...
<div class="wp-block-syntaxhighlighter-code "><pre class="brush: plain; auto-links: false; gutter: false; title: ; title: ; notranslate" title=""><code>curl server1.local
...
<div class="wp-block-syntaxhighlighter-code "><pre class="brush: plain; auto-links: false; title: ; title: ; notranslate" title=""><code>server:
  verbosity: 2
