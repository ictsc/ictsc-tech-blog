...
<div class="wp-block-syntaxhighlighter-code "><pre class="brush: plain; title: ; title: ; notranslate" title=""><code>$ kubectl apply -f ~/manifests/30-networkpolicy.yaml</code></pre></div>
