...
<div class="wp-block-syntaxhighlighter-code "><pre class="brush: plain; title: ; title: ; notranslate" title=""><code>ping -f &lt;ipv4アドレスの宛先&gt;</code></pre></div>
...
<div class="wp-block-syntaxhighlighter-code "><pre class="brush: plain; title: ; title: ; notranslate" title=""><code>R1#ping 192.168.0.2
...
<div class="wp-block-syntaxhighlighter-code "><pre class="brush: plain; title: ; title: ; notranslate" title=""><code>R1#ping 192.168.255.2 source 192.168.255.1
Type escape sequence to abort.
...
<div class="wp-block-syntaxhighlighter-code "><pre class="brush: plain; title: ; title: ; notranslate" title=""><code>R3#ping 192.168.0.2 source 192.168.255.3
Type escape sequence to abort.
Sending 5, 100-byte ICMP Echos to 192.168.0.2, timeout is 2 seconds:
...
<div class="wp-block-syntaxhighlighter-code "><pre class="brush: plain; title: ; title: ; notranslate" title=""><code>R3#ping 192.168.0.1 source 192.168.255.3
Type escape sequence to abort.
