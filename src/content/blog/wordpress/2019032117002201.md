...
<pre class="brush: plain; title: ; title: ; notranslate" title=""><code>connect_from_port_20=YES</code></pre>
<ul>
<li>以下のルールを削除・無効化してはいけない。</li>
</ul>
<pre class="brush: plain; title: ; title: ; notranslate" title=""><code>iptables -A OUTPUT -p tcp --sport 20 -j REJECT</code></pre>
<h1>解説</h1>
...
<pre class="brush: plain; title: ; title: ; notranslate" title=""><code>DATA PORT (PORT)
